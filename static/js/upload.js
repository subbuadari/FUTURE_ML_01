...
function processFile() {
    ...
    .then(async response => {
        ...
        try {
            ...
            return Promise.reject({
                ...
                details: text || parseError.message
            });
        }

        if (!response.ok) {
            return Promise.reject(data || { error: 'Server error', details: text });
        }
    ...
    .catch(error => {
        const message = error?.error || error?.message || 'An error occurred during processing';
